...
module ex (
    ...
    output reg         bp_actual_taken_o,
     ...
     // Zbkb zip 语义：把 rs1[15:0] 与 rs1[31:16] 逐 bit 交织。
     // 显式固定连线避免综合成可变交叉开关，结果只在 rd 写回路径局部选择。
     wire [31:0] zip_result_w = {
         alu_op1[31], alu_op1[15], alu_op1[30], alu_op1[14],
         alu_op1[29], alu_op1[13], alu_op1[28], alu_op1[12],
         alu_op1[27], alu_op1[11], alu_op1[26], alu_op1[10],
         alu_op1[25], alu_op1[9],  alu_op1[24], alu_op1[8],
         alu_op1[23], alu_op1[7],  alu_op1[22], alu_op1[6],
         alu_op1[21], alu_op1[5],  alu_op1[20], alu_op1[4],
         alu_op1[19], alu_op1[3],  alu_op1[18], alu_op1[2],
         alu_op1[17], alu_op1[1],  alu_op1[16], alu_op1[0]
     };
    ...
    always @(*) begin
        ...
        if (rv32m_busy_o == 1'b1) begin
            ...
            if (dec_is_zip_i) begin
                rd_addr_o = rd_addr_i;
                rd_data_o = zip_result_w;
                rd_wen_o  = rd_wen_i;
            end
