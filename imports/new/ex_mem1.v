...
module ex_mem1 (
    ...
    dff_set #(4)  dff_mem_wd_reg      (clk, rst, 1'b0, 1'b0, 4'b0,      mem_wd_reg_i,      mem_wd_reg_o);
    dff_set #(32) dff_mem_wd_addr     (clk, rst, 1'b0, 1'b0, 32'b0,     mem_wd_addr_i,     mem_wd_addr_o);
