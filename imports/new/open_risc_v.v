...
module open_risc_v (
    ...
    id id_inst (
        ...
        .ex_is_unzip_o   (id_dec_is_unzip_o),
    ...
    id_ex id_ex_inst (
        ...
        .ex_is_unzip_i   (id_dec_is_unzip_o),
        ...
        .ex_is_unzip_o   (id_ex_is_unzip_o),
    ...
    ex ex_inst (
        ...
        .dec_is_unzip_i      (id_ex_is_unzip_o),
