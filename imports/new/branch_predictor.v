...
module branch_predictor #(    
    ...
    wire [6:0] funct3  = if_inst_i[14:12];
    ...
    wire [BHT_ADDR_WIDTH-1:0] update_idx    = update_pc_idx ^ ghr_r;
    ...
    wire [RAS_PTR_WIDTH-1:0] ras_top_idx = (ras_sp_r =={RAS_PTR_WIDTH{1'b0}}) ? {RAS_DEPTH - 1} : (ras_sp_r - 1'b1);
