...
module branch_predictor #(
    ...
    localparam [RAS_PTR_WIDTH-1:0] RAS_LAST_PTR   = RAS_DEPTH - 1;
    localparam [RAS_PTR_WIDTH:0]   RAS_DEPTH_COUNT = RAS_DEPTH;
    ...
    wire branch_pred_taken_w  = bht_valid[pred_idx] ? bht[pred_idx][1] : btfnt_taken;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            if (ras_pop_en_i || ras_push_en_i) begin
                ...
                if (ras_pred_pop && ras_nonempty) begin
