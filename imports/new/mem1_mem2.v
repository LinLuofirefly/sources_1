...
module mem1_mem2 (
    ...
    (* max_fanout = 4*)output wire [31:0] inst_o,
    (* max_fanout = 4*)output wire [4:0]  rd_addr_o,
    (* max_fanout = 4*)output wire [31:0] rd_data_o,
    (* max_fanout = 4*)output wire        rd_wen_o,
    ...
    (* max_fanout = 4*)output wire [31:0] bp_update_target_o,
    (* max_fanout = 4*)output wire [`BP_GHR_WIDTH-1:0] bp_update_ghr_o,
    (* max_fanout = 4*)output wire        bp_ras_push_en_o,
    (* max_fanout = 4*)output wire        bp_ras_pop_en_o,
    (* max_fanout = 4*)output wire [31:0] bp_ras_push_addr_o,
    (* max_fanout = 4*)output wire        bp_actual_taken_o
);
