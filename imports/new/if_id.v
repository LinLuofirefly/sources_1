...
module if_id (
    ...
    assign valid_o     = rst & ~flush_flag_i & (is_holding_reg | push_valid_i);
    ...
    always @(posedge clk) begin
        if (rst == 1'b0 || flush_flag_i == 1'b1) begin
            ...
            if (consume_i == 1'b1) begin
                if (push_valid_i == 1'b1) begin
        ...
        end else if ((push_valid_i == 1'b1) && (consume_i == 1'b0)) begin
            hold_inst_reg           <= inst_i;
            hold_inst_addr_reg      <= inst_addr_i;
            hold_pred_taken_reg     <= pred_taken_i;
            hold_raw_pred_taken_reg <= raw_pred_taken_i;
