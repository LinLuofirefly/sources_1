...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_rev8_o,
    ...
    // rev8 是固定字节重排指令。flush/reset 清零，hold 保持，
    // 保证重排 valid 与 rs1 数据同步进入 EX。
    wire ex_is_rev8_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_rev8_o :
                       ex_is_rev8_i;
