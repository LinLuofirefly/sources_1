...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_orc_b_o,
    ...
    // orc.b 是单周期按字节归约 OR 指令。flush/reset 清零，hold 保持，
    // 确保 valid 位与 rs1 数据同拍进入 EX。
    wire ex_is_orc_b_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_orc_b_o :
                       ex_is_orc_b_i;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            ex_is_orc_b_o   <= ex_is_orc_b_next;
