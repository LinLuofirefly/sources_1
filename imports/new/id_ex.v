...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_sext_b_o,
    ...
    // sext.b 是单周期固定布线指令。flush 清零，hold 保持，
    // 避免控制位在流水线清空或停顿时与 rs1 数据错位。
    wire ex_is_sext_b_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_sext_b_o :
                       ex_is_sext_b_i;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            ex_is_sext_b_o  <= ex_is_sext_b_next;
