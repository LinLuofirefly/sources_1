...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_rori_o,
    ...
    // rori 是单周期立即数旋转写回指令。flush/reset 清零，hold 保持，
    // 不增加原有指令 CPI，且不会进入 PC 重定向控制锥。
    wire ex_is_rori_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_rori_o :
                       ex_is_rori_i;
