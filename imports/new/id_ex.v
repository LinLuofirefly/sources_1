...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_bclr_o,
    ...
    // bclr 是单周期单比特写回指令。flush/reset 清零，hold 保持，
    // 使 valid 与 rs1/rs2 数据严格对齐。
    wire ex_is_bclr_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_bclr_o :
                       ex_is_bclr_i;
