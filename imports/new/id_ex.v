...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_xperm8_o,
    ...
    // xperm8 是多周期 byte 交叉选择指令。flush/reset 清零，hold 保持，
    // 确保 start、busy、done 与流水线中的指令一一对应。
    wire ex_is_xperm8_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_xperm8_o :
                       ex_is_xperm8_i;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            ex_is_xperm8_o  <= ex_is_xperm8_next;
