...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_clmulr_o,
    ...
    // clmulr 是迭代多周期指令。flush/reset 清零，hold 保持，
    // 只让新增指令自身承担固定多周期延迟。
    wire ex_is_clmulr_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_clmulr_o :
                       ex_is_clmulr_i;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            ex_is_clmulr_o  <= ex_is_clmulr_next;
