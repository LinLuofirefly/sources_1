...
module id_ex (
    ...
    // Excessive register replication can worsen physical routing timing.
     ...
     output reg [2:0]  rs2_fwd_sel_o,
     output reg        use_rs1_o,
     output reg        use_rs2_o,
     output reg        use_base_addr_o,
     ...
     output reg        ex_is_load_o,
     output reg        ex_is_store_o,
     output reg        ex_is_jal_o,
     output reg        ex_is_jalr_o,
     output reg        ex_is_auipc_o,
     output reg        ex_is_lui_o,
     output reg        ex_is_system_o,
     output reg        ex_is_rv32m_o,
     output reg        ex_is_csr_op_o,
     output reg        ex_is_call_jal_o,
     output reg        ex_ras_should_push_jalr_o,
     output reg        ex_ras_should_pop_jalr_o,
     output reg        ex_ras_predicted_jalr_o
);
