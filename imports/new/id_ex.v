...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_minu_o,
    ...
    // minu 是单周期无符号比较选择指令。flush/reset 清零，hold 保持，
    // 使 valid 与 rs1/rs2 数据同步穿过 ID/EX。
    wire ex_is_minu_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_minu_o :
                       ex_is_minu_i;
