...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_packh_o,
    ...
    // packh 是单周期固定拼接指令。flush/reset 清零，hold 保持，
    // 保证控制位与 rs1/rs2 数据同步。
    wire ex_is_packh_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_packh_o :
                       ex_is_packh_i;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            ex_is_packh_o   <= ex_is_packh_next;
