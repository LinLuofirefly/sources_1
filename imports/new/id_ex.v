...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_clmul_o,
    ...
    // clmul 是迭代多周期指令。flush/reset 清零，hold 保持，
    // 确保 start 只对应流水线中真实保留的这一条指令。
    wire ex_is_clmul_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_clmul_o :
                       ex_is_clmul_i;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            ex_is_clmul_o   <= ex_is_clmul_next;
