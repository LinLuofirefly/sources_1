...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_cpop_o,
    ...
    // cpop 当前保持单周期平衡加法树实现。flush/reset 清零，hold 保持，
    // 使提交控制与 rs1 数据保持同拍。
    wire ex_is_cpop_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_cpop_o :
                       ex_is_cpop_i;
