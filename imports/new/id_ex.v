...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_sext_h_o,
    ...
    // sext.h 是单周期固定布线写回指令。flush/reset 清零，hold 保持，
    // 使该 valid 位与对应 rs1 数据严格同步。
    wire ex_is_sext_h_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_sext_h_o :
                       ex_is_sext_h_i;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            ex_is_sext_h_o  <= ex_is_sext_h_next;
