...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_unzip_o,
    ...
    // unzip 是单周期固定布线指令。flush/reset 清零，hold 保持，
    // 只影响该指令写回，不改变原有指令 CPI。
    wire ex_is_unzip_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_unzip_o :
                       ex_is_unzip_i;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            ex_is_unzip_o   <= ex_is_unzip_next;
