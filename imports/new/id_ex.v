...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_xnor_o,
    ...
    // xnor 为单周期布尔写回指令。flush/reset 清零，hold 保持，
    // 让控制位与 rs1/rs2 数据在 ID/EX 中保持一致。
    wire ex_is_xnor_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_xnor_o :
                       ex_is_xnor_i;
