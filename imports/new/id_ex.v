...
module id_ex (
    ...
    (* extract_enable = "no" *) output reg        ex_is_brev8_o,
    ...
    // brev8 是固定布线单周期指令。flush/reset 清零，hold 保持，
    // 避免控制位与 rs1 数据在流水暂停时错位。
    wire ex_is_brev8_next =
        flush_flag_i ? 1'b0 :
        hold_flag_i  ? ex_is_brev8_o :
                       ex_is_brev8_i;
    ...
    always @(posedge clk) begin
        if (rst == 1'b0) begin
            ...
            ex_is_brev8_o   <= ex_is_brev8_next;
