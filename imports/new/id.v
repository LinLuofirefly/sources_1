...
module id (
    ...
    wire is_rori        = (opcode == `INST_TYPE_I) &&
                          (func3 == 3'b101) &&
                          (func7 == 7'b0110000);
    ...
    // Zbb/Zbkb rori 标准编码：opcode=0010011, funct3=101, funct7=0110000，shamt=inst[24:20]。
    // ID 完整匹配固定字段，EX 只用已传递的立即数低 5 位，不再读取 inst_i 译码。
    assign ex_is_rori_o             = is_rori;
