...
module id (
    ...
    wire is_sh1add      = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b010) &&
                          (func7 == 7'b0010000);
    ...
    // Zba sh1add 标准编码：opcode=0110011, funct3=010, funct7=0010000。
    // 在 ID 阶段精确译码，只向 EX 传递 1 个 valid 位，避免 EX 再比较完整 inst_i。
    assign ex_is_sh1add_o           = is_sh1add;
