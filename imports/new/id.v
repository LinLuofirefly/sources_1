...
module id (
    ...
    wire is_bexti       = (opcode == `INST_TYPE_I) &&
                          (func3 == 3'b101) &&
                          (func7 == 7'b0100100);
    ...
    // Zbs bexti 标准编码：opcode=0010011, funct3=101, funct7=0100100，shamt=inst[24:20]。
    // 该指令只读取 rs1，ID 只向 EX 传递一个专用 valid，避免 EX 再扇出完整 inst_i。
    assign ex_is_bexti_o            = is_bexti;
