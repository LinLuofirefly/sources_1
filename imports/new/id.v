...
module id (
    ...
    wire is_max         = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b110) &&
                          (func7 == 7'b0000101);
    ...
    // Zbb max 标准编码：opcode=0110011, funct3=110, funct7=0000101。
    // 比较选择只影响写回数据，EX 不再用完整 inst_i 译码，也不复用分支比较网络。
    assign ex_is_max_o              = is_max;
