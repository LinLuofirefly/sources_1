...
module id (
    ...
    wire is_binv        = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b001) &&
                          (func7 == 7'b0110100);
    ...
    // Zbs binv 标准编码：opcode=0110011, funct3=001, funct7=0110100。
    // 位编号只取 rs2[4:0]；掩码仅在新增指令写回路径局部生成。
    assign ex_is_binv_o             = is_binv;
