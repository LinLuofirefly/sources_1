...
module id (
    ...
    wire is_xperm4      = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b010) &&
                          (func7 == 7'b0010100);
    ...
    // Zbkx xperm4 标准编码：opcode=0110011, funct3=010, funct7=0010100。
    // 该指令读取 rs1/rs2，EX 采用逐 nibble 迭代选择，避免单周期大型交叉开关。
    assign ex_is_xperm4_o           = is_xperm4;
