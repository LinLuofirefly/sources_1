...
module id (
    ...
    wire is_bext        = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b101) &&
                          (func7 == 7'b0100100);
    ...
    // Zbs bext 标准编码：opcode=0110011, funct3=101, funct7=0100100。
    // 位编号只取 rs2[4:0]；动态位选择只用于写回结果，不接入 PC 重定向控制锥。
    assign ex_is_bext_o             = is_bext;
