...
module id (
    ...
    wire is_pack        = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b100) &&
                          (func7 == 7'b0000100);
    ...
    // Zbkb pack 标准编码：opcode=0110011, funct3=100, funct7=0000100。
    // 该 R 型指令读取 rs1/rs2，EX 只接收一个 valid，避免把完整 inst_i 扩散到写回选择。
    assign ex_is_pack_o             = is_pack;
