...
module id (
    ...
    wire is_ror         = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b101) &&
                          (func7 == 7'b0110000);
    ...
    // Zbb/Zbkb ror 标准编码：opcode=0110011, funct3=101, funct7=0110000。
    // 旋转量来自 rs2[4:0]；只向 EX 传 1 个 valid 位，避免 EX 重新译码 inst_i。
    assign ex_is_ror_o              = is_ror;
