...
module id (
    ...
    wire is_packh       = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b111) &&
                          (func7 == 7'b0000100);
    ...
    // Zbkb packh 标准编码：opcode=0110011, funct3=111, funct7=0000100。
    // 该指令读取 rs1/rs2，只传递一个专用 valid，避免 EX 再使用完整 inst_i 译码。
    assign ex_is_packh_o            = is_packh;
