...
module id (
    ...
    wire is_xnor        = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b100) &&
                          (func7 == 7'b0100000);
    ...
    // Zbb/Zbkb xnor 标准编码：opcode=0110011, funct3=100, funct7=0100000。
    // ID 阶段精确译码后只传 1 位 valid，避免 EX 阶段重复比较完整 inst_i。
    assign ex_is_xnor_o             = is_xnor;
