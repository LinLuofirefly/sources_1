...
module id (
    ...
    wire is_orn         = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b110) &&
                          (func7 == 7'b0100000);
    ...
    // Zbb/Zbkb orn 标准编码：opcode=0110011, funct3=110, funct7=0100000。
    // 只把 1 位 valid 传入 EX，避免新增完整指令译码拉长写回选择路径。
    assign ex_is_orn_o              = is_orn;
