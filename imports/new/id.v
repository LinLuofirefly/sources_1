...
module id (
    ...
    wire is_bset        = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b001) &&
                          (func7 == 7'b0010100);
    ...
    // Zbs bset 标准编码：opcode=0110011, funct3=001, funct7=0010100。
    // 位编号只取 rs2[4:0]；掩码在 EX 写回路径局部生成，不影响普通 ALU 输入。
    assign ex_is_bset_o             = is_bset;
