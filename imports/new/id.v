...
module id (
    ...
    wire is_min         = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b100) &&
                          (func7 == 7'b0000101);
    ...
    // Zbb min 标准编码：opcode=0110011, funct3=100, funct7=0000101。
    // ID 阶段精确译码，只传递 1 个 valid 位；EX 的比较只服务写回，不复用分支比较网络。
    assign ex_is_min_o              = is_min;
