...
module id (
    ...
    wire is_sext_h      = (opcode == `INST_TYPE_I) &&
                          (func3 == 3'b001) &&
                          (inst_i[31:20] == 12'h605);
    ...
    // Zbb sext.h 标准编码：opcode=0010011, funct3=001, imm[11:0]=011000000101。
    // 这是 rs1 一元指令，ID 精确译码后只向 EX 传递 1 个 valid 位，不引入 rs2 依赖。
    assign ex_is_sext_h_o           = is_sext_h;
