...
module id (
    ...
    wire is_xperm8      = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b100) &&
                          (func7 == 7'b0010100);
    ...
    // Zbkx xperm8 标准编码：opcode=0110011, funct3=100, funct7=0010100。
    // 该指令逐 byte 选择，EX 采用固定 4 拍迭代，避免大型单周期交叉开关。
    assign ex_is_xperm8_o           = is_xperm8;
