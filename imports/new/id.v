...
module id (
    ...
    wire is_clmulr      = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b010) &&
                          (func7 == 7'b0000101);
    ...
    // Zbc clmulr 标准编码：opcode=0110011, funct3=010, funct7=0000101。
    // 迭代 GF(2) 乘法器最终写回 product[62:31]，避免把大 XOR 网络放在 EX 单周期路径。
    assign ex_is_clmulr_o           = is_clmulr;
