...
module id (
    ...
    wire is_rev8        = (opcode == `INST_TYPE_I) &&
                          (func3 == 3'b101) &&
                          (inst_i[31:20] == 12'h698);
    ...
    // Zbb/Zbkb rev8 标准编码：opcode=0010011, funct3=101, imm[11:0]=011010011000。
    // ID 完整匹配后只传递 valid 位，EX 不再比较 inst_i。
    assign ex_is_rev8_o             = is_rev8;
