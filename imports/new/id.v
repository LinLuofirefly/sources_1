...
module id (
    ...
    wire is_sext_b      = (opcode == `INST_TYPE_I) &&
                          (func3 == 3'b001) &&
                          (inst_i[31:20] == 12'h604);
    ...
    // Zbb sext.b 标准编码：opcode=0010011, funct3=001, imm[11:0]=011000000100。
    // 一元 OP-IMM 指令只依赖 rs1，不产生 rs2 数据相关；EX 只接收该 valid 位。
    assign ex_is_sext_b_o           = is_sext_b;
