...
module id (
    ...
    wire is_andn        = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b111) &&
                          (func7 == 7'b0100000);
    ...
    // Zbb/Zbkb andn 标准编码：opcode=0110011, funct3=111, funct7=0100000。
    // 在 ID 阶段精确译码，EX 只接收 1 个 valid 位，避免新增 inst_i 比较进入 EX 写回选择路径。
    assign ex_is_andn_o             = is_andn;
