...
module id (
    ...
    wire is_sh2add      = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b100) &&
                          (func7 == 7'b0010000);
    ...
    // Zba sh2add 标准编码：opcode=0110011, funct3=100, funct7=0010000。
    // 在 ID 阶段做完整字段匹配，EX 阶段只接收 1 个 valid 位，避免把 inst_i 比较放到写回关键路径。
    assign ex_is_sh2add_o           = is_sh2add;
