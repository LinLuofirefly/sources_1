...
module id (
    ...
    wire is_cpop        = (opcode == `INST_TYPE_I) &&
                          (func3 == 3'b001) &&
                          (inst_i[31:20] == 12'h602);
    ...
    // Zbb cpop 标准编码：opcode=0010011, funct3=001, imm[11:0]=011000000010。
    // 一元指令只依赖 rs1；ID 提前译码后只传 1 个 valid 位。
    assign ex_is_cpop_o             = is_cpop;
