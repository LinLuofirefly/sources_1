...
module id (
    ...
    wire is_brev8       = (opcode == `INST_TYPE_I) &&
                          (func3 == 3'b101) &&
                          (imm == 12'h687);
    ...
    // Zbkb brev8 标准编码：opcode=0010011, funct3=101, imm[11:0]=0x687。
    // 这是 rs1 的每个字节内部 bit reverse，不需要 rs2；提前译码后 EX 只看一个 valid。
    assign ex_is_brev8_o            = is_brev8;
