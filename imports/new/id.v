...
module id (
    ...
    wire is_clmulh      = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b011) &&
                          (func7 == 7'b0000101);
    ...
    // Zbc clmulh 标准编码：opcode=0110011, funct3=011, funct7=0000101。
    // ID 只传递一个 valid，EX 用迭代 GF(2) 乘法器取高 32 位，避免单周期宽 XOR 网络。
    assign ex_is_clmulh_o           = is_clmulh;
