...
module id (
    ...
    wire is_sh3add      = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b110) &&
                          (func7 == 7'b0010000);
    ...
    // Zba sh3add 标准编码：opcode=0110011, funct3=110, funct7=0010000。
    // 提前在 ID 精确译码，只传递 1 个专用 valid 位，避免 EX 写回路径重新比较 inst_i。
    assign ex_is_sh3add_o           = is_sh3add;
