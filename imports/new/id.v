...
module id (
    ...
    wire is_bclr        = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b001) &&
                          (func7 == 7'b0100100);
    ...
    // Zbs bclr 标准编码：opcode=0110011, funct3=001, funct7=0100100。
    // 位编号只取 rs2[4:0]；ID 提前译码，EX 局部生成掩码，只影响写回数据。
    assign ex_is_bclr_o             = is_bclr;
