...
module id (
    ...
    wire is_rol         = (opcode == `INST_TYPE_R_M) &&
                          (func3 == 3'b001) &&
                          (func7 == 7'b0110000);
    ...
    // Zbb/Zbkb rol 标准编码：opcode=0110011, funct3=001, funct7=0110000。
    // 旋转量来自 rs2[4:0]；ID 只传 valid，EX 只在写回路径计算旋转结果。
    assign ex_is_rol_o              = is_rol;
