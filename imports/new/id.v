...
module id (
    ...
    wire is_bseti       = (opcode == `INST_TYPE_I) &&
                          (func3 == 3'b001) &&
                          (func7 == 7'b0010100);
    ...
    // Zbs bseti 标准编码：opcode=0010011, funct3=001, funct7=0010100，shamt=inst[24:20]。
    // 立即数形式不使用 rs2；EX 只通过立即数通道获取 shamt。
    assign ex_is_bseti_o            = is_bseti;
