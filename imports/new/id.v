...
module id (
    ...
    wire is_clz         = (opcode == `INST_TYPE_I) &&
                          (func3 == 3'b001) &&
    ...
    // Zbb clz 标准编码：opcode=0010011, funct3=001, imm[11:0]=011000000000。
    // 一元指令只依赖 rs1；ID 提前译码，EX 只接收 1 位 valid，避免完整 inst_i 进入 EX 关键路径。
    assign ex_is_clz_o              = is_clz;
