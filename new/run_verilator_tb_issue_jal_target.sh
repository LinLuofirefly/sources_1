...
cd "$(dirname "$0")/.."
rm -rf obj_dir_tb_issue_jal_target

verilator --binary --timing --trace --top-module tb_issue_jal_target \
  -Wno-fatal \
  -Iimports/new \
  new/tb_issue_jal_target.sv \
  ...
  --Mdir obj_dir_tb_issue_jal_target

./obj_dir_tb_issue_jal_target/Vtb_issue_jal_target
